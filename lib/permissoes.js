...
// no editor de permissões. Módulos "informativos" (visão geral, boletos
// ainda em construção) só têm visualizar por enquanto.
export const ACOES_POR_MODULO = {
  visao_geral: ["visualizar"],
  boletos: ["visualizar", "editar"],
...
export const DEFAULT_PERMISSOES_BY_PAPEL = {
  ...
  // liberar (membros.requer_aprovacao, ligado por padrão).
  subsindico: {
    visao_geral: ["visualizar"],
    boletos: ["visualizar"],
    chamados: ["visualizar", "criar", "editar"],
