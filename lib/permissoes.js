...
// "propostas" continua sendo uma permissão concedível (mantém o
// controle de quem cria/edita/aprova propostas, incluindo o papel
// conselheiro, que existe só pra isso) mas NÃO tem mais página/rota
// própria nem entrada no menu — propostas agora vivem dentro de cada
// registro de Manutenção ou Obras (ver PropostasDoRegistro). Por isso
// "propostas" não aparece em MODULO_ROUTES; o menu lateral filtra essa
// chave explicitamente ao montar a navegação (ver DashboardSidebar).
...
export const ACOES_POR_MODULO = {
  ...
  propostas: ["visualizar", "criar", "editar", "aprovar"],
