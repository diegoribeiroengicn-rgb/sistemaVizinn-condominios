...
// Stripe's practical minimum charge amount in BRL — usado pra nunca
// tentar criar um PaymentIntent abaixo disso mesmo com cupom aplicado
// (a rota de pagamento pula o PaymentIntent inteiramente quando o
// valor final é zero — ver /api/create-payment-intent).
export const VALOR_MINIMO_COBRANCA_CENTAVOS = 50; // R$ 0,50
